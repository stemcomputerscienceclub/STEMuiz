...
async function joinGameSession({ pin, playerName }) {
  try {
    ...
    console.log('Adding player to player_sessions table...');
    ...
    console.log('Player insert result:', player || 'No player data');
    console.log('Player insert error:', playerError || 'No error');
